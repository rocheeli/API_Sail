	...
	public static void main(String[] args)
	{
		try
		{
			...
			// email of new employee (address@email.com)
			 String email = "goobledygook@gmail.com";

			// home phone # of new employee (###-##-####)
			 String homePhone = "301-555-0171";

			// cell phone # of new employee (###-##-####)
			 String cellPhone = "301-555-3663";

			// employee password (at least one cap, one lower case, number, and
			// eight char)
			 String password = "Vz123456";
